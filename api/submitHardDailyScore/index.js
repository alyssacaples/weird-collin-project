...
module.exports = async function (context, req) {
    context.log('Submitting hard mode daily high score');
...
const newScore = {
    ...
    date: new Date().toISOString()
        ...
        context.res = {
            ...
            body: { success: true, message: "Daily score submitted successfully" }
        };
    } catch (error) {
        context.log.error('Error submitting hard mode daily score:', error);
        context.res = {
            status: 500,
            body: { error: 'Failed to submit daily score' }
        };
    }
};
